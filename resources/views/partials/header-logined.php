            ...
            <div class="top-act__group d-md-none">
                <div class="top-act__btn-wrap">
                    <button class="top-act__btn">
                        ...
                        <span class="top-act__title"><?= count($favorites) ?></span>
                    </button>
                        ...
                        <div class="act-dropdown__inner">
                            ...
                            <div class="act-dropdown__top">
                                <h2 class="act-dropdown__title">
                                    You have <?= count($favorites) ?> item<?= count($favorites) != 1 ? 's' : '' ?>
                                </h2>
                                    ...
                                    <?php foreach($favorites as $item): ?>
                                        <div class="col">
                                            <article class="cart-preview-item">
                                                ...
                                                <p class="cart-preview-item__price">$<?= number_format($item['base_price'], 2) ?></p>
                                            </article>
                                        </div>
                                    <?php endforeach; ?>
                                <?php else: ?>
