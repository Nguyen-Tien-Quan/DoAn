            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <form method="GET" class="form-inline">
                        ...
                        <input type="text" name="search" class="form-control mr-2" placeholder="Mã, tên"
                        ...
                        <a href="admin.php?url=vouchers" class="btn btn-secondary ml-2">Reset</a>
                    </form>
                </div>
            </div>
                                ...
                                <?php else: ?>
                                    <?php foreach ($vouchers as $v): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= (int)($v['used_count'] ?? 0) . ' / ' . ($v['usage_limit'] ? $v['usage_limit'] : '∞') ?>
                                            </td>
                                            <td>
                                                <?php if ($v['status'] == 1): ?>
                                            ...
                                            <?php if ($is_admin): ?>
                                                <td style="white-space: nowrap;">
                                                    ...
                                                    <?php if ($v['status'] == 1): ?>
                                                        <a href="admin.php?url=vouchers&action=delete&id=<?= $v['id'] ?>"
                                                    ...
                                                    <?php else: ?>
                                                        <a href="admin.php?url=vouchers&action=restore&id=<?= $v['id'] ?>"
                                                    ...
                                                    <?php endif; ?>
                                                    <a href="admin.php?url=vouchers&action=hard_delete&id=<?= $v['id'] ?>"
                                        ...
                                        <div class="modal fade" id="editModal<?= $v['id'] ?>" tabindex="-1">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form method="POST" action="admin.php?url=vouchers&action=edit">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label>Giá trị</label>
                                                                        <input type="number" step="1000" name="discount_value"
                                                                               class="form-control" value="<?= $v['discount_value'] ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label>Đơn tối thiểu</label>
                                                                        <input type="number" step="1000" name="min_order_amount"
                                                                               class="form-control" value="<?= $v['min_order_amount'] ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" step="1000" name="max_discount_amount"
                                                                               class="form-control" value="<?= $v['max_discount_amount'] ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="datetime-local" name="start_date" class="form-control"
                                                                               value="<?= $v['start_date'] ? date('Y-m-d\TH:i', strtotime($v['start_date'])) : '' ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="datetime-local" name="end_date" class="form-control"
                                                                               value="<?= $v['end_date'] ? date('Y-m-d\TH:i', strtotime($v['end_date'])) : '' ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                               value="<?= (int)($v['used_count'] ?? 0) ?>" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                        ...
                        <ul class="pagination justify-content-center">
                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                                    <a class="page-link" href="?url=vouchers&page=<?= $i ?>&search=<?= urlencode($search) ?>&discount_type=<?= $type_filter ?>&status=<?= $status_filter ?>">
                                        <?= $i ?>
                                    </a>
                                </li>
                            <?php endfor; ?>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="admin.php?url=vouchers&action=add">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Giá trị</label>
                                <input type="number" step="1000" name="discount_value" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Đơn tối thiểu</label>
                                <input type="number" step="1000" name="min_order_amount" class="form-control" value="0">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Giảm tối đa</label>
                                <input type="number" step="1000" name="max_discount_amount" class="form-control" value="0">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
