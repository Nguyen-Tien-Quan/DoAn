-- =============================================
-- DATABASE: QLBTHUCAN
-- Hệ thống quản lý bán đồ ăn nhanh (Burger, Gà rán, Combo, Đồ uống)
-- =============================================
...
-- =========================================
-- 23. PASSWORD_RESETS - Quên mật khẩu
-- =========================================
...
ADD COLUMN otp VARCHAR(6) AFTER token;

-- =========================================
-- 24. FAVORITES - Yêu thích
-- =========================================
...
-- =========================================
-- 25. SHIPPING_ADDRESSES - Địa chỉ giao hàng
-- =========================================
...
-- =========================================
-- 26. MENU_ITEMS - Quản lý menu động (navbar, footer)
-- =========================================
CREATE TABLE menu_items (
    ...
    status TINYINT DEFAULT 1,
    roles TEXT NULL COMMENT 'JSON array of role IDs allowed to see this menu',
    created_at TIMESTAMP NULL,
    updated_at TIMESTAMP NULL,
...
-- =========================================
-- 28. PROMOTIONS - Chương trình khuyến mãi
-- =========================================
...
-- =========================================
-- 29. SUPPORT_ARTICLES - Hỗ trợ (FAQ)
-- =========================================
...
-- =========================================
-- 30. PAGES - Trang tĩnh (Giới thiệu, Liên hệ, Chính sách...)
-- =========================================
CREATE TABLE pages (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    title VARCHAR(200) NOT NULL,
...
(1, 2),
(2, 3),
(3, 4);  -- user_id 4 không tồn tại, nhưng giữ để test
...
('Cách làm burger bò phô mai tại nhà', 'cach-lam-burger-bo-pho-mai', 'Chỉ 15 phút với nguyên liệu đơn giản, bạn đã có bữa sáng hoàn hảo...', '<p>Nội dung chi tiết về cách làm burger bò phô mai tại nhà.</p>', 'assets/img/blog/blog-1.jpg', 'Công thức', 120, 1, NOW()),
('Phân biệt Arabica và Robusta', 'phan-biet-arabica-robusta', 'Hương vị, độ caffeine và cách chọn cà phê phù hợp với khẩu vị...', '<p>Bài viết phân tích chi tiết hai loại cà phê phổ biến.</p>', 'assets/img/blog/blog-2.jpg', 'Kiến thức', 85, 1, NOW()),
('Top 5 loại trà đào được yêu thích nhất', 'top-5-tra-dao', 'Thanh mát, giải nhiệt – lựa chọn hàng đầu cho mùa hè...', '<p>Review 5 loại trà đào bán chạy nhất tại TRQshop.</p>', 'assets/img/blog/blog-3.jpg', 'Review', 200, 1, NOW());
